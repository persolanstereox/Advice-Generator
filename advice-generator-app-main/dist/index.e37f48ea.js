...
var _adviceVievJs = require("./adviceViev.js");
var _adviceVievJsDefault = parcelHelpers.interopDefault(_adviceVievJs);
...
const getAdvice = async function() {
    try {
        const res = await Promise.race([
            fetch(_configJs.URL_ADVICE),
            timeout(_configJs.TIMEOUT_SECONDS)
        ]);
        console.log(res);
        if (!res.ok) throw new Error("Problem getting advice");
        const data = await res.json();
        (0, _adviceVievJsDefault.default).generateAdvice(data.slip);
    } catch (err) {
        (0, _adviceVievJsDefault.default).generateError();
    }
};
...
window.addEventListener("click", (e)=>{
    ...
    if (target) {
        ...
        (0, _adviceVievJsDefault.default).generateSpinner(target.firstElementChild);
        setTimeout(getAdvice, _configJs.LOAD_NEW_RECIPE_SECONDS * 1000);
    }
});

},{"core-js/modules/es.regexp.flags.js":"gSXXb","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime":"dXNgZ","./adviceViev.js":"kSg4H","./config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime/runtime":"dXNgZ"}],"gSXXb":[function(require,module,exports) {
...
},{}],"kSg4H":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconDiceSvg = require("url:../img/icon-dice.svg");
var _iconDiceSvgDefault = parcelHelpers.interopDefault(_iconDiceSvg);
var _patternDividerDesktopSvg = require("../img/pattern-divider-desktop.svg");
var _patternDividerDesktopSvgDefault = parcelHelpers.interopDefault(_patternDividerDesktopSvg);
class adviceViev {
    ...
    generateAdvice(data) {
        ...
        <div class="advice__box">
            ...
            <img class="divider" src="${(0, _patternDividerDesktopSvgDefault.default)}" alt="divider">
            <button class="btn--new__advice">
            <img  src="${(0, _iconDiceSvgDefault.default)}" alt="dice"> 
            </button>
        </div>`;
        this.#clear();
...
exports.default = new adviceViev();

},{"url:../img/icon-dice.svg":"5pHSu","../img/pattern-divider-desktop.svg":"9OOsp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5pHSu":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("hWUTQ") + "icon-dice.42e05b15.svg" + "?" + Date.now();
...
},{}],"9OOsp":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("hWUTQ") + "pattern-divider-desktop.405f50b6.svg" + "?" + Date.now();
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "URL_ADVICE", ()=>URL_ADVICE);
parcelHelpers.export(exports, "TIMEOUT_SECONDS", ()=>TIMEOUT_SECONDS);
parcelHelpers.export(exports, "LOAD_NEW_RECIPE_SECONDS", ()=>LOAD_NEW_RECIPE_SECONDS);
const URL_ADVICE = "https://api.adviceslip.com/advice";
const TIMEOUT_SECONDS = 10;
const LOAD_NEW_RECIPE_SECONDS = 2;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire487d")
